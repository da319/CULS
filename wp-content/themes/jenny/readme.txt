...
Go to Appearance > Themes and use the Installer tool, or copy the theme folder 'modernist' in wp-content/themes/ and activate it.


How to use "Full Width, No Sidebar" page template
---------------------------------------------------
...
Go to Pages > New. Create a page as you would do normally. Before saving, choose "Full Width, No Sidebar" from the template list in the right.


Release notes and known bugs
----------------------------

If the WordPress is in the debug mode, clicking on "Save chnages" and "Reset" buttons in Jenny Theme Options page gives (harmless) error messages.
